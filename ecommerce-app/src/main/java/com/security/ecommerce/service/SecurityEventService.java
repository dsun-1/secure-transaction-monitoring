...
public class SecurityEventService {
    ...
    public SecurityEvent logEvent(SecurityEvent event) {
        ...
        // forward to monitoring microservice asynchronously
        eventForwardingService.forwardEvent(saved);
    ...
    public SecurityEvent logAuthenticationAttempt(String username, String ipAddress,
        ...
        event.setEventType(successful ? SecurityEvent.EventType.LOGIN_SUCCESS : SecurityEvent.EventType.LOGIN_FAILURE);
        event.setUsername(username);
        event.setIpAddress(ipAddress);
        event.setUserAgent(userAgent);
        event.setSuccessful(successful);
        event.setSeverity(successful ? SecurityEvent.EventSeverity.LOW : SecurityEvent.EventSeverity.MEDIUM);
